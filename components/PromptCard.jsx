...
const PromptCard = ({ post, handleEdit, handleDelete, handleTagClick }) => {
  ...
  return (post && post.creator &&
    <div className='prompt_card_new'>
      ...
      <p className='my-4 font-satoshi text-sm text-zinc-300'>{post.prompt}</p>
      <p
        className='font-inter text-sm text-[#69c3ff] cursor-pointer'
      ...
      {session?.user.id === post.creator._id && pathName === "/profile" && (
        <div className='mt-5 flex-center gap-4 border-t border-gray-100 pt-3'>
          ...
          <p
            className='font-inter text-sm text-[#ff738a] cursor-pointer'
